        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-white">
            <h2 className="text-white mb-6 text-3xl lg:text-4xl">
              Ready to modernise your payments?
            </h2>
            <p className="text-lg text-indigo-100 leading-relaxed">
              Collect recurring, one-off, and high-value payments real-time — even mid-conversation.
            </p>
          </div>
          ...
          <div className="space-y-5">
            <a
              ...
              className="w-full px-8 py-4 bg-white text-indigo-600 rounded-xl hover:bg-indigo-50 transition-all shadow-xl hover:shadow-2xl flex items-center justify-center gap-3 group"
            >
